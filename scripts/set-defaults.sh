...
COLLECTION="settings"
PAYLOAD=`{"project_name": "Dungeon Construction Co.", "project_url": "'"${NEXT_PUBLIC_CMS_URL}"'", "project_color": "#FFA439", "public_registration": "true", "public_registration_role": "5ad2a6f5-74a6-4ebc-9864-5e7b451203d2"  }`
